...
, http-client, http-client-tls, http-conduit, http-types, markdown
...
, transformers, wai, wai-extra, wai-logger, warp, yaml, yesod
...
mkDerivation {
  ...
  buildDepends = [
    ...
    http-client-tls http-conduit http-types markdown monad-control
