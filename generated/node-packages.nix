...
in
{
  foundation-sites = nodeEnv.buildNodePackage {
    ...
    version = "6.7.3";
    src = fetchurl {
      url = "https://registry.npmjs.org/foundation-sites/-/foundation-sites-6.7.3.tgz";
      sha512 = "HgQA6iUQTEkRSeNwiRQH2PvTXkXGBfBpRS6CTm2auhKpyU4Tea7so3IPKrazSciE7nyv1Vp9WNKdH9fBPLbGeA==";
    };
