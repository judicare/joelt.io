...
, markdown, mtl, network-uri, pcre-light, process-extras
, pwstore-fast, safecopy, shakespeare, stdenv, template-haskell
, text, time, transformers, utf8-string, vault, wai, wai-app-static
...
mkDerivation {
  ...
  executableHaskellDepends = [
    ...
    http-types ixset-typed markdown mtl network-uri pcre-light
    process-extras pwstore-fast safecopy shakespeare template-haskell
    text time transformers utf8-string vault wai wai-app-static
    wai-extra wai-session wai-session-clientsession warp web-routes
  ];
